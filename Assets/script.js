...
document.getElementById("submitInitials").onclick = function() {showScores()};
function showScores() {
  var text = userInitials.value;
  var submittedScore = countdown.textContent;
  var li = document.createElement("li");
  li.innerHTML = "Initials: " + text + " " + " " + "|" + " " + "Score: " + submittedScore;
...
localStorage.setItem("highScoresStored", highScoresStored);
...
// this will force a reload of the page and wipe the scores.
// const reloadButton = document.querySelector("#clearScores");
// function reload() {
